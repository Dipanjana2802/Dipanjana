#Reference:
#https://github.com/kubeflow/examples/blob/master/object_detection/serving_script/object_detection_grpc_client.py
...
from core.standard_fields import \
...
def main(args):
    ...
    #Initialize prediction request to our model
