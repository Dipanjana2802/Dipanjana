...
input_shape = model.layers[0].output_shape[1:3]    #output shape[1:3] gives height & width of the tensor
...
# For example,if we have 100 steps per epoch and a batch-size of 20, so the "epoch" consists of 2000 random images from the training-set
